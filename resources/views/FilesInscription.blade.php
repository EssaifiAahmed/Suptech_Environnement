        ...
        <div class="container" data-aos="fade-up">
            <div class="col-lg-12" data-aos="fade-up" data-aos-delay="300">
                <form method="POST" id="OrderInfo"
                    action="{{ route('uploadfiles_Inscr.storefile', ['id' => session()->get('cni'), 'slug' => App::getLocale()]) }}"
                    ...
                    <div class="row">
                        <a class="mb-3" style="color:red;"><i class="bi bi-asterisk "></i>
                            {{ __('messages.msgnotes') }} </a> <br>
                        <div class="col-lg-4 form-group">
                            <label>{{ __('messages.note_s1') }}</label>
                            <input type="text" class="form-control" name="note_s1" id="note_s1"
                                placeholder=" {{ __('messages.note_s1') }}">
                        </div>

                        <div class="col-lg-4 form-group">
                            <label>{{ __('messages.note_s2') }}</label>
                            <input type="text" class="form-control" name="note_s2" id="note_s2"
                                placeholder=" {{ __('messages.note_s2') }}">
                        </div>

                        <div class="col-lg-4 form-group">
                            <label>{{ __('messages.moy_A1') }}</label>
                            <input type="text" class="form-control" name="note_A1" id="note_A1"
                                placeholder=" {{ __('messages.moy_A1') }} ">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 form-group">
                            ...
                            <input type="text" class="form-control" name="note_s3" id="note_s3"
                                placeholder=" {{ __('messages.note_s3') }}">
                        </div>

                        <div class="col-lg-4 form-group">
                            <label>{{ __('messages.note_s4') }}</label>
                            <input type="text" class="form-control" name="note_s4" id="note_s4"
                                placeholder=" {{ __('messages.note_s4') }}">
                        </div>

                        <div class="col-lg-4 form-group">
                            <label>{{ __('messages.moy_A2') }}</label>
                            <input type="text" class="form-control" name="note_A2" id="note_A2"
                                placeholder=" {{ __('messages.moy_A2') }} ">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 form-group">
                            ...
                            <input type="text" class="form-control" name="note_s5" id="note_s5"
                                placeholder=" {{ __('messages.note_s5') }}">
                        </div>

                        <div class="col-lg-4 form-group">
                            <label>{{ __('messages.note_s6') }}</label>
                            <input type="text" class="form-control" name="note_s6" id="note_s6"
                                placeholder=" {{ __('messages.note_s6') }}">
                        </div>

                        <div class="col-lg-4 form-group">
                            <label>{{ __('messages.moy_A3') }}</label>
                            <input type="text" class="form-control" name="note_A3" id="note_A3"
                                placeholder=" {{ __('messages.moy_A3') }} ">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 form-group">
                            ...
                            <input type="text" class="form-control" name="note_s7" id="note_s7"
                                placeholder=" {{ __('messages.note_s7') }}">
                        </div>

                        <div class="col-lg-4 form-group">
                            <label>{{ __('messages.note_s8') }}</label>
                            <input type="text" class="form-control" name="note_s8" id="note_s8"
                                placeholder=" {{ __('messages.note_s8') }}">
                        </div>

                        <div class="col-lg-4 form-group">
                            <label>{{ __('messages.moy_A4') }}</label>
                            <input type="text" class="form-control" name="note_A4" id="note_A4"
                                placeholder=" {{ __('messages.moy_A4') }} ">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 form-group">
                            ...
                            <input type="text" class="form-control" name="note_s9" id="note_s9"
                                placeholder=" {{ __('messages.note_s9') }}">
                        </div>

                        <div class="col-lg-4 form-group">
                            <label>{{ __('messages.note_s10') }}</label>
                            <input type="text" class="form-control" name="note_s10" id="note_s10"
                                placeholder=" {{ __('messages.note_s10') }}">
                        </div>

                        <div class="col-lg-4 form-group">
                            <label>{{ __('messages.moy_A5') }}</label>
                            <input type="text" class="form-control" name="note_A5" id="note_A5"
                                placeholder=" {{ __('messages.moy_A5') }} ">
                        </div>
                    </div>
                    ...
                    @if (Session::has('locale'))
                        @if (Session::get('locale') == 'fr')
                            ...
                            @foreach (session()->get('message') as $msg)
                                <a class="mb-3" style="color:red;"><i
                                        class="bi bi-asterisk "></i>{{ $msg }}</a> <br>
                                <div class="mb-2"></div>


                                <input class="form-control" name="releve[]" type="file" accept="application/pdf"
                                    multiple style="padding:6px;" id="file" required>
                            @endforeach
                        @endif
                    @endif
                    ...
                    @if (Session::has('locale'))
                        @if (Session::get('locale') == 'ar')
                            ...
                            @for ($i = 0; $i < $count; $i++)
                                ...
                                <a class="mb-3" style="color:red;"><i
                                        class="bi bi-asterisk "></i>{{ $msg_ar }}</a> <br>
                                <div class="mb-2"></div>
