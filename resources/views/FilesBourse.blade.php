  ...
  <h1 style="text-align:center" class="mt-5">  {{__('messages.ddd')}} </h1>
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <form method="POST" id="OrderInfo" action="{{ route('uploadfiles.storefile',[ 'id' => session()->get('cne'), 'slug' => App::getLocale()]) }}" enctype="multipart/form-data" class="php-email-form">
    @csrf
...
<label>{{ $msg}} </label>
      ...
      <input class="form-control" name="{{ $msg}}" type="file" accept="application/pdf" style="padding:6px;" id="file" >
