  ...
  align-items: center;"><img class="logo-left" src="{{ public_path('logo.png') }}"
    ...
    <table>
        ...
        <tr>
            ...
            <td>{{ $request->nom_mere_complet }}</td>
        </tr>

        <tr>
            <td id="header">Profession du mère :</td>
            <td>{{ $request->profession_mere }}</td>
        </tr>

        <tr>
            <td id="header">Nom du tuteur:</td>
            <td>{{ $request->nom_tuteur_complet }}</td>
        </tr>

        <tr>
            <td id="header">Profession du tuteur :</td>
            <td>{{ $request->profession_tuteur }}</td>
        </tr>
