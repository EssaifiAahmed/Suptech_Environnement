        ...
        <div class="main-content">
            ...
            <div class="page-title-area">
                ...
                <div class="main-content-inner">
                    <div class="row">
                        <div class="col-lg-2">
                            <a href="{{ route('exportBourse', ['slug' => App::getLocale(), 'Type' => 'All']) }}"
                                id="ExcelExport">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if ($data->fichier_complets == 'true')
                                                                <a href="{{ route('downloadBourseFiles', ['slug' => App::getLocale(), 'userCNE' => $data->cne]) }}"
                                                        ...
                                                        <td>
                                                            <form method="post"
                                                                action="{{ route('DeleteRegisterBourse', ['id' => $data->id, 'slug' => App::getLocale()]) }} ">
                                                                @csrf
                                                                @method('DELETE')
                                                        ...
                                                        <td>
                                                            <a
                                                                href="{{ route('PdfStudentBourse', ['id' => $data->id, 'slug' => App::getLocale()]) }}">Télécharger</a>
                                                        </td>
                                ...
                                if (idx === 10) {
                                    select.on('change', function() {
                                        ...
                                        if ($(this).find('option:selected').text()) {
                                            ...
                                            var url =
                                                "{{ route('exportBourse', ['slug' => App::getLocale(), 'Type' => ':type']) }}";
                                            url = url.replace(':type', test);
                                            document.getElementById("ExcelExport").href = url;
                                        } else {
                                            document.getElementById("ExcelExport").href =
                                                "{{ route('exportBourse', ['slug' => App::getLocale(), 'Type' => 'All']) }}";
                                        }
