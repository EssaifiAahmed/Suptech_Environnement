...
<body>
    ...
    <section id="portfolio" class="portfolio section-bg">
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="section-title">
                <h2> {{ __('messages.ad') }} SUPTECH ENVIRONNEMENT </h2>
                ...
                @foreach ($images as $image)
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                        <div class="portfolio-wrap">
                            <a href="{{ asset('Galerie/' . $image->name) }}" data-gallery="portfolioGallery"
    ...
    <script>
        ...
        $(window).scroll(function() {
            ...
            if (!hasDisplayedAlert2 && $(window).scrollTop() + $(window).height() >= $('.my-class').offset().top +
                $('.my-class').outerHeight()) {
                    ...
                    success: function(response) {
                        ...
                        for (var i = 0; i < response.length; i++) {
                            ...
                            var htmll = "<div class='col-lg-4 col-md-6 portfolio-item filter-web'>" +
                                "<div class='portfolio-wrap'>" +
                                "<a href='" + "{{ asset('Galerie/') }}/" + response[i].name +
                                "' data-gallery='portfolioGallery' class='portfolio-lightbox'>" +
                                "<img src='" + "{{ asset('Galerie/') }}/" + response[i].name +
                                "' class='img-fluid' alt=''>" +
                                "</a>" +
                                "</div>" +
                                "</div>";
